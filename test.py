...
client = Client(api_key="74dfaaa8c7d60ea26735bc24abe91146f34b58d4c3359052053ce34c763439b4")
...
print("Best flights found:", len(best_flights))
if best_flights:
    print(json.dumps(best_flights[0], indent=2))